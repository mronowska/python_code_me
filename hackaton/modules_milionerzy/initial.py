...
def welcome():
    print(f"""
{colors.colors.HEADER}---------------------------Witaj w grze Milionerzy!---------------------------
-------------Odpowiedz poprawnie na 10 pytań i wygraj milion $$$$-------------{colors.colors.ENDC}

{colors.colors.BOLD}Aby przejść do kolejnej treści/części gry, kliknij dowolny klawisz :){colors.colors.ENDC}

{colors.colors.OKBLUE}O GRZE:
