...
def phone_call(question_category, right_answer_number):
    ...
    if friend_category == question_category:
        ...
        print(f"\nCiekawe... Czy to nie jest zbyt ryzykowne, aby na pytanie dotyczące tematu {question_category} dzwonimy do specjalisty temacie {friend_category}? Niestety, nie ma już powrotu, trzymamy kciuki! HALO {colors.colors.WARNING}{friend_name.upper()}{colors.colors.ENDC}!")
