...
def who_is_your_friend():
    ...
    print(
        f"""{colors.colors.OKBLUE}**** Przed rozpoczęciem gry musisz wybrać, kto dziś pomoże Ci w odpowiedzi na pytania! WHO'S YOUR FRIEND? ****{colors.colors.ENDC}\n
